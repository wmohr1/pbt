	...
	<cfquery name="q_LogTransaction" datasource="#THIS.DSN#">
		INSERT INTO
			...
			VALUES
				...
				'#UCase(q_GetLogInfo.BENEFIT_LVL)#',
				'#session.pbt_PREF_DEF_FY#',
                
                '#q_GetLogInfo.NEW_EMP_GROUP#',
                '#q_GetLogInfo.NEW_EMP_SUBGROUP#',
                '#q_GetLogInfo.NEW_PERS_SUBAREA#',
                '#q_GetLogInfo.NEW_PAY_SCALE_GROUP#',
                '#q_GetLogInfo.NEW_JOB_CODE_DESC#',
				'#q_GetLogInfo.NEW_ANNUAL_SALARY#',
                '#q_GetLogInfo.NEW_POSITION#',
                '#q_GetLogInfo.NEW_JOB_CODE#',
                '#q_GetLogInfo.NEW_FTE#',
                '#q_GetLogInfo.NEW_CAP_UTIL#',
                '#q_GetLogInfo.NEW_EXEMPT_INDICATOR#',
                '#q_GetLogInfo.NEW_JOB_KEY#',
                '#q_GetLogInfo.NEW_PDOC_LEVEL#',
                '#q_GetLogInfo.NEW_CLASS#')
	</cfquery>
</cfloop>